...
```yaml
files:
  - path: "source/isaaclab_tasks/.../pickplace_xxx_env_cfg.py"
    content: "完整文件内容"
  - path: "source/isaaclab_tasks/.../pick_place/__init__.py"
    content: "完整文件内容或明确 patch 方案"
summary: "生成说明"
commands:
  - "python scripts/environments/teleoperation/teleop_se3_agent.py --task ..."
```
